    ...
    <div>
      ...
      <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-6">
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-semibold text-primary-foreground mb-4">Floor Plans</h1>
          <p className="text-primary-foreground/80 text-lg md:text-xl max-w-xl mx-auto">Find the perfect home for your lifestyle</p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-5xl">
          <SectionReveal>
            <div className="text-center mb-12">
              <p className="text-accent font-semibold text-sm uppercase tracking-widest mb-3">Choose Your Home</p>
            ...
            <div className="glass-card rounded-2xl overflow-hidden">
              <div className="grid lg:grid-cols-2">
                <div className="relative aspect-[4/3] lg:aspect-auto">
                  <img
                    src={activeTab === "standard" ? buildingExterior : apartmentInterior}
                    alt={`${activeTab} apartment`}
                ...
                <div className="p-8 lg:p-12 space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 pt-4">
                    <button className="flex items-center justify-center gap-2 bg-secondary text-secondary-foreground px-5 py-3 rounded-xl font-semibold transition-all hover:bg-muted">
                      <Download className="w-4 h-4" />
                      Download PDF
                    </button>
                    <Link
                      to="/contact"
                      className="flex items-center justify-center gap-2 bg-accent text-accent-foreground px-5 py-3 rounded-xl font-semibold transition-all duration-300 hover:brightness-110"
                    >
          ...
          <SectionReveal delay={0.3}>
            <div className="text-center mt-16 glass-card p-10 rounded-2xl">
              <h3 className="font-display text-2xl font-semibold text-primary mb-3">Have Questions?</h3>
              <p className="text-muted-foreground text-lg mb-6">
                Call our leasing office for current availability and pricing.
              </p>
              <a
                href="tel:16313635760"
                className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-7 py-3.5 rounded-xl font-semibold transition-all duration-300 hover:brightness-110"
              >
