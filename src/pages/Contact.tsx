          ...
          <div className="grid lg:grid-cols-5 gap-12">
              ...
              <SectionReveal>
                <div className="space-y-6">
                  ...
                  <a href="tel:16313635760" className="flex items-start gap-4 group">
                    <div className="w-11 h-11 border border-accent/30 flex items-center justify-center flex-shrink-0 group-hover:bg-accent/10 transition-colors">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-11 h-11 border border-accent/30 flex items-center justify-center flex-shrink-0">
            ...
            <div className="lg:col-span-3">
              <SectionReveal delay={0.1}>
                <div className="sharp-card p-8 md:p-10">
                  <h3 className="font-display text-2xl font-semibold text-primary mb-6">Request Information</h3>
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                      <label className="block text-sm font-semibold text-foreground mb-2">Name *</label>
                      <input type="text" required value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} className="w-full px-5 py-3 bg-secondary text-foreground placeholder:text-muted-foreground border-0 focus:outline-none focus:ring-2 focus:ring-accent text-base" placeholder="Your full name" />
                    </div>
                    <div className="grid sm:grid-cols-2 gap-5">
                      <div>
                        <label className="block text-sm font-semibold text-foreground mb-2">Email *</label>
                        <input type="email" required value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} className="w-full px-5 py-3 bg-secondary text-foreground placeholder:text-muted-foreground border-0 focus:outline-none focus:ring-2 focus:ring-accent text-base" placeholder="email@example.com" />
                      </div>
                      <div>
                        <label className="block text-sm font-semibold text-foreground mb-2">Phone *</label>
                        <input type="tel" required value={formData.phone} onChange={(e) => setFormData({ ...formData, phone: e.target.value })} className="w-full px-5 py-3 bg-secondary text-foreground placeholder:text-muted-foreground border-0 focus:outline-none focus:ring-2 focus:ring-accent text-base" placeholder="(555) 123-4567" />
                      </div>
                    </div>
                    <div className="grid sm:grid-cols-2 gap-5">
                      <div>
                        <label className="block text-sm font-semibold text-foreground mb-2">Apartment Size *</label>
                        <select required value={formData.apartmentSize} onChange={(e) => setFormData({ ...formData, apartmentSize: e.target.value })} className="w-full px-5 py-3 bg-secondary text-foreground border-0 focus:outline-none focus:ring-2 focus:ring-accent text-base">
                      ...
                      <div>
                        ...
                        <select value={formData.apartmentLevel} onChange={(e) => setFormData({ ...formData, apartmentLevel: e.target.value })} className="w-full px-5 py-3 bg-secondary text-foreground border-0 focus:outline-none focus:ring-2 focus:ring-accent text-base">
                    ...
                    <div>
                      ...
                      <textarea rows={4} value={formData.message} onChange={(e) => setFormData({ ...formData, message: e.target.value })} className="w-full px-5 py-3 bg-secondary text-foreground placeholder:text-muted-foreground border-0 focus:outline-none focus:ring-2 focus:ring-accent text-base resize-none" placeholder="Tell us about what you're looking for..." />
                    </div>
                    <button type="submit" className="w-full bg-accent text-accent-foreground px-7 py-3.5 font-semibold transition-all duration-300 hover:brightness-110 active:scale-[0.98] flex items-center justify-center gap-2">
